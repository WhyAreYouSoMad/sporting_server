...
public class StadiumCompanyTest {
    ...
    void findAllMyList() throws Exception {
        ...
        stadiumMyListOutDTO.add(new StadiumMyListOutDTO(6L, "배구", "a 배구장", new StadiumFileResponseDTO(1L, "경기장 URL1")));
        stadiumMyListOutDTO.add(new StadiumMyListOutDTO(7L, "배구", "b 배구장", new StadiumFileResponseDTO(2L, "경기장 URL2")));
        stadiumMyListOutDTO.add(new StadiumMyListOutDTO(8L, "배구", "c 배구장", new StadiumFileResponseDTO(3L, "경기장 URL1")));
