...
VALUES (1, 1, 'a 야구장', '010-0234-5678', 1, '부산시', 35.1846, 128.9863, 5, '09:00', '18:00', '등록', Now(), NOW()),
       (2, 1, 'b 야구장', '010-1234-5678', 1, '부산시', 35.2098, 129.0811, 6, '09:00', '18:00', '등록', Now(), NOW()),
       (3, 2, 'a 농구장', '010-2234-5678', 4, '울산시', 37.2936, 126.8679, 7, '09:00', '18:00', '등록', Now(), NOW()),
       (4, 2, 'b 농구장', '010-3234-5678', 4, '울산시', 37.3226, 126.8593, 8, '09:00', '18:00', '등록', Now(), NOW()),

       (5, 2, 'a 축구장', '010-4234-5672', 2, '울산시', 37.3226, 126.8593, 15, '09:00', '18:00', '등록', Now(), NOW()),
       (6, 2, 'a 배구장', '010-4234-5673', 3, '울산시', 37.3226, 126.8593, 16, '09:00', '18:00', '등록', Now(), NOW()),
       (7, 2, 'b 배구장', '010-4234-5673', 3, '울산시', 37.3226, 126.8593, 17, '09:00', '18:00', '등록', Now(), NOW()),
       (8, 2, 'c 배구장', '010-4234-5673', 3, '울산시', 37.3226, 126.8593, 18, '09:00', '18:00', '등록', Now(), NOW()),
       (9, 2, 'a 풋살장', '010-4234-5675', 5, '울산시', 37.3226, 126.8593, 19, '09:00', '18:00', '등록', Now(), NOW()),
       (10, 2, 'a 볼링장', '010-4234-5676', 6, '울산시', 37.3226, 126.8593, 20, '09:00', '18:00', '등록', Now(), NOW()),
       (11, 2, 'b 볼링장', '010-4234-5676', 6, '울산시', 37.3226, 126.8593, 21, '09:00', '18:00', '등록', Now(), NOW()),
       (12, 2, 'c 볼링장', '010-4234-5676', 6, '울산시', 37.3226, 126.8593, 22, '09:00', '18:00', '등록', Now(), NOW()),
       (13, 2, 'a 탁구장', '010-4234-5677', 7, '울산시', 37.3226, 126.8593, 23, '09:00', '18:00', '등록', Now(), NOW()),
       (14, 2, 'a 테니스장', '010-4234-5678', 8, '울산시', 37.3226, 126.8593, 24, '09:00', '18:00', '등록', Now(), NOW()),
       (15, 2, 'b 테니스장', '010-4234-5678', 8, '울산시', 37.3226, 126.8593, 25, '09:00', '18:00', '등록', Now(), NOW()),
       (16, 2, 'c 테니스장', '010-4234-5678', 8, '울산시', 37.3226, 126.8593, 26, '09:00', '18:00', '등록', Now(), NOW());

INSERT INTO stadium_court_tb(id, stadium_id, file_info_id, court_price, capacity, content, status, created_at, updated_at) 
VALUES (1, 1, 9, 40000, 22, '최신 시설 야구장', '등록완료', now(), now()), 
       (2, 2, 10, 60000, 22, '선수 운영 야구장', '등록완료', now(), now()), 
       (3, 3, 11, 30000, 10, '그물상태 양호 농구장', '등록완료', now(), now()),
       (4, 3, 12, 30000, 10, '코트상태 양호 농구장', '등록완료', now(), now()), 
       (5, 4, 13, 50000, 10, '교통편리 위치 농구장', '등록완료', now(), now()), 
       (6, 4, 14, 50000, 10, '생수 무료제공 농구장', '등록완료', now(), now()),

       (7, 10, 27, 20000, 10, 'a 볼링장 - 1', '등록완료', now(), now()),
       (8, 10, 28, 20000, 10, 'a 볼링장 - 2', '등록완료', now(), now()),
       (9, 10, 29, 20000, 10, 'a 볼링장 - 3', '등록완료', now(), now()),
       (10, 12, 30, 30000, 10, 'c 볼링장 - 1', '등록완료', now(), now()),
       (11, 12, 31, 30000, 10, 'c 볼링장 - 2', '등록완료', now(), now()),
       (12, 12, 32, 30000, 10, 'c 볼링장 - 3', '등록완료', now(), now());
