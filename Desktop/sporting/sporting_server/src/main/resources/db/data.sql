...
VALUES (1, 1, 'a 야구장', '010-1234-5678', 1, '부산시 사상구 모라1동 123-4', 35.1846, 128.9863, 5, '09:00', '18:00', '등록', Now(), NOW()),
       (2, 1, 'b 야구장', '010-2234-5678', 1, '부산시 동래구 명륜동 223-4', 35.2098, 129.0811, 6, '09:00', '18:00', '등록대기', Now(), NOW()),
       (3, 2, 'a 농구장', '010-3234-5678', 4, '안산시 상록구 본오동 323-4', 37.2936, 126.8679, 7, '09:00', '18:00', '등록', Now(), NOW()),
       (4, 2, 'b 농구장', '010-4234-5678', 4, '안산시 상록구 부곡동 423-4', 37.3226, 126.8593, 8, '09:00', '18:00', '등록대기', Now(), NOW());

INSERT INTO stadium_court_tb(id, stadium_id, file_info_id, court_price, capacity, content, status, created_at, updated_at) 
VALUES (1, 1, 9, 40000, 22, '최신 시설 야구장', '등록', now(), now()), -- 부산시 사상구 모라1동 123-4
       (2, 2, 10, 60000, 22, '선수 운영 야구장', '등록', now(), now()), -- 부산시 동래구 명륜동 223-4
       (3, 3, 11, 30000, 10, '그물상태 양호 농구장', '등록', now(), now()), -- 안산시 상록구 본오동 323-4
       (4, 3, 12, 40000, 10, '코트상태 양호 농구장', '등록', now(), now()), -- ''
       (5, 4, 13, 50000, 10, '교통편리 위치 농구장', '등록', now(), now()), -- ''
       (6, 4, 14, 60000, 10, '생수 무료제공 농구장', '등록', now(), now()); -- ''
